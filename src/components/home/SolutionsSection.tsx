...
export function SolutionsSection({
  ...
  return (
    <section className="relative overflow-hidden bg-[#f4fcfc] px-6 py-24 lg:px-8">
      ...
      <div className="absolute bottom-0 right-0 h-96 w-96 rounded-full bg-brand-primary/10 blur-3xl" />
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          ...
          <Link
            href="/solutions"
            className="group inline-flex w-fit items-center gap-2 rounded-full border border-brand-secondary/30 bg-white px-6 py-4 text-sm font-bold text-brand-primary shadow-sm transition hover:-translate-y-0.5 hover:border-brand-secondary hover:bg-brand-primary hover:text-white"
          >
            View all solutions
